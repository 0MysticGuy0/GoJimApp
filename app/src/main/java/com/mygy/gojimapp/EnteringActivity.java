...
import com.mygy.gojimapp.data.Constants;
...
public class EnteringActivity extends AppCompatActivity {
    ...
    private void showRegisterWindow(){
        ...
        ImageView ico = regestrationView.findViewById(R.id.register_ico);
        ...
        add.setOnClickListener(v -> {
                ...
                auth.createUserWithEmailAndPassword(email,passwd)
                        .addOnSuccessListener(res -> {
                            ...
                            usersBase.collection(Constants.USERS_BASE).add(user.getUserDocument())
                                    .addOnSuccessListener( docRef -> {
                                        user.setDockId(docRef.getId());
                                        user.setEmail(email);
                                        user.setName(name);
